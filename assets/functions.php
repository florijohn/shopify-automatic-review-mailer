<?php
    ...
    function buildMsg () {
        $subject = "Ein Fahrer ist auf dem Weg zu dir!";
        $msg = '<!DOCTYPE html>
        <html lang="de">
        <head>
            <title>Deine Bestellung bei Als Pizza und Pasta</title>
                            ...
                            <td>
                                ...
                                <tr>
                                    ...
                                    <h1 class="shop-name__text">
                                        <a href="https://als-pizza.de">Als Pizza und Pasta Hamm</a>
                                    </h1>
                                    </td>
                ...
                <table class="row content">
                    ...
                    <td class="content__cell">
                        ...
                        <table class="container">
                            <tr>
                            <td>
                                <h2>Die Zustellung für deine Bestellung läuft</h2>
                                <p>Ein Fahrer ist auf dem Weg zu dir. Deine Lieferung wird in den nächsten 15 Minuten ankommen</p>
                            </td>
                            </tr>
                        </table>
                        </center>
    ...
    function sendEmail() {
        ...
        // custom options
        $mail->addAddress($addressData[3], "Ein Fahrer ist auf dem Weg zu dir!");
